...
(function () {
    ...
    switch (typeof b) {
      ...
      case "object":
        ...
        if (da(b)) {
          var d = b.length;
          c.push("[");
          for (var e = "", f = 0; f < d; f++) c.push(e), e = b[f], Ba(a, a.Td ? a.Td.call(b, String(f), e) : e, c), e = ",";
          c.push("]");
          break
        }
        c.push("{");
        ...
        for (f in b) Object.prototype.hasOwnProperty.call(b, f) && (e = b[f], "function" != typeof e && (c.push(d), Ca(f, c),
          c.push(":"), Ba(a, a.Td ? a.Td.call(b, f, e) : e, c), d = ","));
        c.push("}");
        break;
      case "function":
        break;
  ...
  function Ja() {
    ...
    this.Md = [];
    this.Md[0] = 128;
    for (var a = 1; a < this.Xa; ++a) this.Md[a] = 0;
    this.de = this.dc = 0;
    this.reset()
  }
  ka(Ja, Ia);
  ...
  Ja.prototype.update = function (a, b) {
    if (null != a) {
      p(b) || (b = a.length);
      for (var c = b - this.Xa, d = 0, e = this.le, f = this.dc; d < b;) {
        if (0 == f)
          for (; d <= c;) Ka(this, a, d), d += this.Xa;
        if (q(a))
          for (; d < b;) {
  ...
  (function () {
    var a = "",
      b;
    if (gb && n.opera) return a = n.opera.version, t(a) ? a() : a;
  ...
  function nb(a, b) {
    ...
    this.vd = this.ue = !1;
    if (a == pb) qb(this, rb, b);
    else try {
      var c = this;
      a.call(b, function (a) {
        qb(c, rb, a)
      }, function (a) {
        if (!(a instanceof sb)) try {
  ...
  function qb(a, b, c) {
    if (a.N == ob) {
      if (a == c) b = tb, c = new TypeError("Promise cannot resolve to itself");
      else {
        var d;
        if (c) try {
          d = !!c.$goog_Thenable
  ...
  h.wg = function () {
    for (; this.Ba && this.Ba.length;) {
      var a = this.Ba;
      this.Ba = null;
      for (var b = 0; b < a.length; b++) wb(this, a[b], this.N, this.Pf)
    }
    this.ue = !1
  };
  ...
  function E(a, b, c, d) {
    if ((!d || p(c)) && !t(c)) throw Error(D(a, b, d) + "must be a valid function.");
  }

  function Ob(a, b, c) {
    if (p(c) && (!ga(c) || null === c)) throw Error(D(a, b, !0) + "must be a valid context object.");
  };
  ...
  function ac(a, b) {
    for (var c = !0, d = 0; d < a.vb.length; d++) {
      ...
      if (e)
        if (e = e.bc(), b(e)) {
          for (var e = a.vb[d], f = 0; f < e.ud.length; f++) {
            var g = e.ud[f];
            if (null !== g) {
              e.ud[f] = null;
              var k = g.Yb();
  ...
  nc.prototype.Mf = function () {
    var a = this.ed.get(),
      ...
      c = !1,
      d;
    for (d in a) 0 < a[d] && y(this.Uf, d) && (b[d] = a[d], c = !0);
    c && this.da.Ve(b);
  ...
  function Fc(a, b, c, d, e) {
    ...
    for (e = 1; !a.e();)
      if (e = b ? c(a.key, b) : 1, d && (e *= -1), 0 > e) a = this.Fe ? a.left : a.right;
        ...
        this.Sa.push(a);
        break
      } else this.Sa.push(a), a = this.Fe ? a.right : a.left
  }
  ...
  h.remove = function (a, b) {
    var c, d;
    c = this;
    if (0 > b(a, c.key)) c.left.e() || c.left.ha() || c.left.left.ha() || (c = Mc(c)), c = c.$(null, null, null, c.left.remove(a, b), null);
    else {
      c.left.ha() && (c = Nc(c));
      c.right.e() || c.right.ha() || c.right.left.ha() || (c = Oc(c), c.left.left.ha() && (c = Nc(c), c = Oc(c)));
      if (0 === b(a, c.key)) {
        if (c.right.e()) return Dc;
        d = Jc(c.right);
  ...
  function dd(a, b, c) {
    ...
    if (b === ed) b = (a.mb ? "wss://" : "ws://") + a.$a + "/.ws?";
    else if (b === fd) b = (a.mb ? "https://" : "http://") + a.$a + "/.lp?";
  ...
  function jd(a) {
    ...
    for (var d = a.Xa - 1; 56 <= d; d--) a.le[d] = c & 255, c /= 256;
    Ka(a, a.le);
    for (d = c = 0; 5 > d; d++)
  ...
  function kd(a) {
    for (var b = "", c = 0; c < arguments.length; c++) b = ea(arguments[c]) ? b + kd.apply(null, arguments[c]) : "object" === typeof arguments[c] ? b + F(arguments[c]) : b + arguments[c], b += " ";
    return b
  }
  var cc = null,
    ld = !0;
  ...
  function qd(a) {
    ...
    return {
      ...
      fh: 'kodabots-europe-west-stage-default-rtdb',
      mb: f,
      scheme: g,
      oc: e
    }
  ...
  function vd(a) {
    if ("object" !== typeof a || null === a) return F(a);
    var b = [],
      c;
    for (c in a) b.push(c);
    b.sort();
    c = "{";
    for (var d = 0; d < b.length; d++) 0 !== d && (c += ","), c += F(b[d]), c += ":", c += vd(a[b[d]]);
    return c + "}"
  }
  ...
  Dd.prototype.qg = function (a, b) {
    if (null == a.Ya || null == b.Ya) throw hd("Should only compare child_ events.");
  ...
  function Id(a, b) {
    ...
    if (e) {
      ...
      else if ("child_removed" == c && "child_changed" == f) a.hb[d] = new H("child_removed", e.Le, d);
      else if ("child_changed" == c &&
        "child_added" == f) a.hb[d] = new H("child_added", b.Ma, d);
      else if ("child_changed" == c && "child_changed" == f) a.hb[d] = new H("child_changed", b.Ma, d, e.Le);
      else throw hd("Illegal combination of changes: " + b + " occurred after " + e);
    } else a.hb[d] = b
  };
  ...
  h.ya = function (a, b, c) {
    null != c && (a.L() || a.R(Q, function (a, e) {
      ...
      } else Id(c, new H("child_added", e, b))
    }));
    return b.nb(this.g)
  };
  h.ia = function (a, b) {
  ...
  h.ya = function (a, b, c) {
    ...
    if (b.L() || b.e()) d = G.nb(this.g);
      ...
      for (var e = 0; 0 < b.Sa.length && e < this.ma;) {
        var f = Gc(b),
          g;
        if (g = this.Lb ? 0 >= this.g.compare(this.ua.dd, f) : 0 >= this.g.compare(f, this.ua.Hc)) d = d.W(f.name, f.U), e++;
        else break
      }
    } else {
      d = b.nb(this.g);
      ...
      } else b = d.$b(this.g), k = this.ua.dd,
        m = this.ua.Hc, l = Td(this.g);
      for (var e = 0, x = !1; 0 < b.Sa.length;) f = Gc(b), !x && 0 >= l(k, f) && (x = !0), (g = x && e < this.ma && 0 >= l(f, m)) ? e++ : d = d.W(f.name, G)
    }
  ...
  function Sd(a, b, c, d, e, f) {
    ...
    var m = new K(c, d),
      ...
      r = a.ua.matches(m);
    if (b.Fa(c)) {
      for (var x = b.T(c), l = e.ye(a.g, l, a.Lb); null != l && (l.name == c || b.Fa(l.name));) l = e.ye(a.g, l, a.Lb);
      e = null == l ? 1 : g(l, m);
      if (r && !d.e() && 0 <= e) return null != f && Id(f, new H("child_changed", d, c, x)), b.W(c, d);
      null != f && Id(f, new H("child_removed", x, c));
      b = b.W(c, G);
      return null != l && a.ua.matches(l) ? (null != f && Id(f, new H("child_added",
  ...
  Xd.prototype.fb = function (a, b, c, d) {
    var e = new Hd,
      f;
    if (b.type === zc) b.source.we ? c = Yd(this, a, b.path, b.Ia, c, d, e) : (N(b.source.qf, "Unknown source."), f = b.source.bf || kc(a.w()) && !b.path.e(), c = Zd(this, a, b.path, b.Ia, c, d, f, e));
    else if (b.type === $d) b.source.we ? c = ae(this, a, b.path, b.children, c, d, e) : (N(b.source.qf, "Unknown source."), f = b.source.bf || kc(a.w()), c = be(this, a, b.path, b.children, c, d, f, e));
    else if (b.type === ce)
      if (b.Wd)
        if (b = b.path, null != c.wc(b)) c = a;
        else {
          f = new Tb(c, a, d);
          d = a.Q.j();
          if (b.e() || ".priority" === I(b)) jc(a.w()) ?
            b = c.Aa(Wb(a)) : (b = a.w().j(), N(b instanceof de, "serverChildren would be complete if leaf node"), b = c.Bc(b)), b = this.X.ya(d, b, e);
          else {
            var g = I(b),
              k = c.Ac(g, a.w());
      ...
      else c = fe(this, a, b.path, b.Sb, c, d, e);
    else if (b.type === Bc) d = b.path, b = a.w(), f = b.j(), g = b.ga || d.e(), c = ge(this, new he(a.Q, new Vb(f,
      g, b.Xb)), d, c, Sb, e);
    else throw hd("Unknown operation type: " + b.type);
    e = qa(e.hb);
    d = c;
    b = d.Q;
  ...
  function ge(a, b, c, d, e, f) {
    var g = b.Q;
    if (null != d.wc(c)) return b;
    var k;
    if (c.e()) N(jc(b.w()), "If change path is empty, we must have complete server data"), kc(b.w()) ? (e = Wb(b), d = d.Bc(e instanceof de ? e : G)) : d = d.Aa(Wb(b)), f = a.X.ya(b.Q.j(), d, f);
    else {
      var m = I(c);
      if (".priority" == m) N(1 == je(c), "Can't have a priority with additional path components"), f = g.j(), k = b.w().j(), d = d.kd(c, f, k), f = null != d ? a.X.ia(f, d) : g.j();
      else {
        var l = M(c);
        Ub(g, m) ? (k = b.w().j(), d = d.kd(c, g.j(), k), d = null != d ? g.j().T(m).H(l, d) : g.j().T(m)) : d = d.Ac(m,
          b.w());
  ...
  function Zd(a, b, c, d, e, f, g, k) {
    ...
    else if (g.Qa() && !m.Xb) d = m.j().H(c, d), d = g.ya(m.j(), d, null);
    else {
      var l = I(c);
      if (!lc(m, c) && 1 < je(c)) return b;
      var r = M(c);
      d = m.j().T(l).H(r, d);
  ...
  function Yd(a, b, c, d, e, f, g) {
    var k = b.Q;
    e = new Tb(e, b, f);
    if (c.e()) g = a.X.ya(b.Q.j(), d, g), a = ee(b, g, !0, a.X.Qa());
    else if (f = I(c), ".priority" === f) g = a.X.ia(b.Q.j(), d), a = ee(b, g, k.ga, k.Xb);
    else {
      c = M(c);
      var m = k.j().T(f);
      if (!c.e()) {
  ...
  function fe(a, b, c, d, e, f, g) {
    if (null != e.wc(c)) return b;
    var k = kc(b.w()),
      m = b.w();
    if (null != d.value) {
      if (c.e() && m.ga || lc(m, c)) return Zd(a, b, c, m.j().S(c), e, f, k, g);
      if (c.e()) {
        var l = oe;
  ...
  function Je(a, b, c) {
    var d = ma(a.Bd, function (d, f) {
      ...
      if (d === re) {
        if (g.Jc(b.U)) {
          for (var k = [], m = c.$b(uc), l = Gc(m); l;) l.name != b.name && k.push(l), l = Gc(m);
          k.push(b);
          return Ke(k, Td(g))
        }
        return re
  ...
  h.ac = function (a, b) {
    var c = Re(this, b);
    if (c) return c.ac(a, function (a) {
      return a
    });
    for (var c = this.m.ac(a.name, uc), d = Hc(c); null != d && 0 > b.compare(d, a);) Gc(c), d = Hc(c);
    return c
  };
  h.tf = function (a) {
  ...
  h.cc = function (a, b) {
    var c = Re(this, b);
    if (c) return c.cc(a, function (a) {
      return a
    });
    for (var c = this.m.cc(a.name, uc), d = Hc(c); null != d && 0 < b.compare(d, a);) Gc(c), d = Hc(c);
    return c
  };
  h.Ec = function (a) {
  ...
  h.nb = function (a) {
    if (a === pe || sa(this.yb.gc, a.toString())) return this;
    var b = this.yb,
      c = this.m;
    N(a !== pe, "KeyIndex always exists and isn't meant to be added to the IndexMap.");
    for (var d = [], e = !1, c = c.$b(uc), f = Gc(c); f;) e = e || a.Jc(f.U), d.push(f), f = Gc(c);
    d = e ? Ke(d, Td(a)) : re;
    e = a.toString();
    c = wa(b.gc);
    c[e] = a;
  ...
  function P(a, b) {
    ...
    if ("object" !== typeof a || ".sv" in a) return new Wc(a, P(c));
  ...
  function Ne(a) {
    ...
    } else N(a === ue || a.e(), "priority of unexpected type.");
  ...
  $e.prototype.Yc = function (a) {
    if (this.path.e()) return a = this.children.subtree(new O(a)), a.e() ? null : a.value ? new yc(this.source, L, a.value) : new $e(this.source, L, a);
    ...
    f.onreadystatechange = function () {
      if (d && 4 === f.readyState) {
        ...
        if (200 <= f.status && 300 > f.status) {
          ...
          f.status && R("Got unsuccessful REST response for " + e + " Status: " + f.status), d(f.status);
        d = null
      }
    };
    f.open("GET", e, !0);
  ...
  df.prototype.fe = function (a, b) {
    ...
    for (d = 0; d < c.length; d++) c[d].Cc.apply(c[d].Pa, Array.prototype.slice.call(arguments, 1))
  };
  ...
  function lf(a, b) {
    ...
    this.mf = b;
    for (var c = 0; c < this.Ta.length; c++) this.Ja += Nb(this.Ta[c]);
    mf(this)
  }
  ...
  function mf(a) {
    if (768 < a.Ja) throw Error(a.mf + "has a key path longer than 768 bytes (" + a.Ja + ").");
    if (32 < a.Ta.length) throw Error(a.mf + "path specified exceeds the maximum depth that can be written (32) or object contains a cycle " + nf(a));
  }
  ...
  h.set = function (a, b) {
    if (a.e()) return new of(b, this.children);
    var c = I(a),
  ...
  h.remove = function (a) {
    if (a.e()) return this.children.e() ? oe : new of(null, this.children);
    var b = I(a),
  ...
  var oe = new of(null); of.prototype.toString = function () {
    var a = {};
  ...
  Bf.prototype.Yc = function (a) {
    if (this.path.e()) {
      if (null != this.Sb.value) return N(this.Sb.children.e(), "affectedTree should not have overlapping affected paths."), this;
  ...
  h.Sd = function (a) {
    ...
    if (d) {
      if (e) this.V = Qf(this.pa, Rf, L), this.Nc = 0 < this.pa.length ? this.pa[this.pa.length - 1].jd : -1;
      else if (c.Ia) this.V = this.V.Sd(c.path);
      else {
        var k = this;
  ...
  h.Bc = function (a, b) {
    ...
    } else e = Lf(this.V, a), Na(Kf(e), function (a) {
      c = c.W(a.name, a.U)
    });
    return c
  };
  h.kd = function (a, b, c, d) {
    ...
    a = a.o(b);
    if (null != Jf(this.V, a)) return null;
    a = Lf(this.V, a);
  ...
  h.me = function (a, b, c, d, e, f) {
    ...
    for (f = Gc(e); f && b.length < d;) 0 !== a(f, c) && b.push(f), f = Gc(e);
    return b
  };
  ...
  function Qf(a, b, c) {
    for (var d = Gf, e = 0; e < a.length; ++e) {
      var f = a[e];
      if (b(f)) {
        var g = f.path;
        if (f.Ia) c.contains(g) ? (g = jf(c, g), d = Hf(d, g, f.Ia)) : g.contains(c) && (g = jf(g, c), d = Hf(d, L, f.Ia.S(g)));
        else if (f.children)
          if (c.contains(g)) g = jf(c, g), d = If(d, g, f.children);
          else {
            if (g.contains(c))
              if (g = jf(g, c), g.e()) d = If(d, L, f.children);
              else if (f = z(f.children, I(g))) f = f.S(M(g)), d = Hf(d, L, f)
          }
        else throw hd("WriteRecord should have .snap or .children");
      }
    }
    return d
  }
  ...
  function Vf(a, b) {
    for (var c = b instanceof O ? b : new O(b), d = a, e; null !== (e = I(c));) d = new Uf(e, d, z(d.A.children, e) || new Tf), c = M(c);
    return d
  }
  h = Uf.prototype;
  h.Ea = function () {
  ...
  function fg(a, b, c) {
    ...
    if (t(b)) throw Error(a + "contains a function " + nf(c) + " with contents: " + b.toString());
    if (rd(b)) throw Error(a + "contains " + b.toString() + " " + nf(c));
    ...
    if (ga(b)) {
      ...
      Db(b, function (b, g) {
        if (".value" === b) d = !0;
        else if (".priority" !== b && ".sv" !== b && (e = !0, !cg(b))) throw Error(a + " contains an invalid key (" + b + ") " + nf(c) + '.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
        c.push(b);
        fg(a, g, c);
        c.pop()
      });
  ...
  function gg(a, b) {
    ...
    for (c = 0; c < b.length; c++) {
      ...
      for (var e = d.slice(), f = 0; f < e.length; f++)
        if ((".priority" !== e[f] || f !== e.length - 1) && !cg(e[f])) throw Error(a + "contains an invalid key (" + e[f] + ") in path " + d.toString() + '. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
    }
    b.sort(kf);
    e = null;
    for (c = 0; c < b.length; c++) {
  ...
  function hg(a, b, c) {
    ...
    Db(b, function (a, b) {
      var k = new O(a);
      fg(d, b, c.o(k));
      if (".priority" === ke(k) && !dg(b)) throw Error(d + "contains an invalid value for '" + k.toString() + "', which must be a valid Firebase priority (a string, finite number, server value, or null).");
      e.push(k)
    });
    gg(d, e)
  }
  ...
  function ig(a, b, c) {
    if (rd(c)) throw Error(D(a, b, !1) + "is " + c.toString() + ", but must be a valid Firebase priority (a string, finite number, server value, or null).");
    if (!dg(c)) throw Error(D(a, b, !1) + "must be a valid Firebase priority (a string, finite number, server value, or null).");
  }
  ...
  function kg(a, b) {
    if (p(b) && !cg(b)) throw Error(D(a, 2, !0) + 'was an invalid key: "' + b + '".  Firebase keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]").');
  }

  function lg(a, b) {
    if (!q(b) || 0 === b.length || ag.test(b)) throw Error(D(a, 1, !1) + 'was an invalid path: "' + b + '". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"');
  }
  ...
  function ng(a, b) {
    if (!q(b)) throw Error(D(a, 1, !1) + "must be a valid credential (a string).");
  }

  function og(a, b, c) {
    if (!q(c)) throw Error(D(a, b, !1) + "must be a valid string.");
  }

  function pg(a, b) {
    og(a, 1, b);
    if (!bg.test(b)) throw Error(D(a, 1, !1) + "'" + b + "' is not a valid authentication provider.");
  }

  function qg(a, b, c, d) {
    if (!d || p(c))
      if (!ga(c) || null === c) throw Error(D(a, b, d) + "must be a valid object.");
  }

  function rg(a, b, c) {
    if (!ga(b) || !y(b, c)) throw Error(D(a, 1, !1) + 'must contain the key "' + c + '"');
    if (!q(z(b, c))) throw Error(D(a, 1, !1) + 'must contain the key "' + c + '" with type "string"');
  };
  ...
  function Kg(a) {
    ...
    if (!b.Sc) throw "Unable to find relay frame";
  ...
  Og.prototype.open = function (a, b, c) {
    ...
    var m = Fg(a);
    if (m !== Fg(this.options.relay_url)) c && setTimeout(function () {
      ...
      var r = setInterval(function () {
        l && l.closed &&
          (d(!1), c && (c(T("USER_CANCELLED")), c = null))
      }, 500),
        x = F({
          a: "request",
          d: b
    ...
    e.onreadystatechange = function () {
      if (c && 4 === e.readyState) {
        ...
        if (200 <= e.status && 300 > e.status) {
          ...
          c(null, a)
        } else 500 <= e.status && 600 > e.status ? c(T("SERVER_ERROR")) : c(T("NETWORK_ERROR"));
        c = null;
        Eg(window, "beforeunload", d)
      }
    };
    if ("GET" === f) a += (/\?/.test(a) ? "" : "?") + Gb(b), g = null;
    else {
      var k = this.options.headers.content_type;
  ...
  Rg.prototype.open = function (a, b, c) {
    ...
    (g = window.open(a, "_blank", "location=no")) && t(g.addEventListener) ? (g.addEventListener("loadstart", function (a) {
      ...
      b && (a = Gg(a.url), g.removeEventListener("exit",
        d), g.close(), a = new wg(null, null, {
          requestId: e.sc,
          requestKey: a
  ...
  function ch(a) {
    var b = a.G;
    if ("europe-west1.firebasedatabase.app" !== b.domain && "firebaseio.com" !== b.domain && "firebaseio-demo.com" !== b.domain && "auth.firebase.com" === vg) throw Error("This custom Firebase server ('" + a.G.domain + "') does not support delegated login.");
  };
  var ed = "websocket",
    fd = "long_polling";
    ...
    sd(function () {
      if (!c.Bb) {
        c.Va = new mh(function (a, b, d, k, m) {
          nh(c, arguments);
          if (c.Va)
            if (c.sb && (clearTimeout(c.sb), c.sb = null), c.Ic = !0, "start" == a) c.id = b, c.Tg = d;
            else if ("close" === a) b ? (c.Va.Sf = !1, hh(c.Df, b, function () {
              c.ab()
            })) : c.ab();
  ...
  function ph(a) {
    if (a.ke && a.Sf && a.Qe.count() < (0 < a.$c.length ? 2 : 1)) {
      ...
      b.pw = a.Cf;
      b.ser = a.se;
      for (var b = a.hd(b), c = "", d = 0; 0 < a.$c.length;)
  ...
  wh.prototype.open = function (a, b) {
    ...
    try {
      this.Ka = new vh(this.ff, [], {
        headers: {
          "User-Agent": "Firebase/5/" + Cb + "/" + process.platform + "/Node"
        }
      })
    } catch (c) {
    ...
    this.Ka.onmessage = function (a) {
      if (null !== e.Ka)
        if (a = a.data, e.pb += a.length, pc(e.Wa, "bytes_received", a.length), yh(e), null !== e.frames) zh(e, a);
        else {
          a: {
  ...
  function Eh(a) {
    if (0 < a.fd.length) return a.fd[0];
  ...
  function Gh(a) {
    ...
    0 < b && (a.yd = setTimeout(function () {
      a.yd = null;
      a.Cb || (a.K && 102400 < a.K.pb ? (a.f("Connection exceeded healthy timeout but has received " + a.K.pb + " bytes.  Marking connection healthy."), a.Cb = !0, a.K.Ed()) : a.K && 10240 < a.K.qb ? a.f("Connection exceeded healthy timeout but has sent " +
        a.K.qb + " bytes.  Leaving connection alive.") : (a.f("Closing unhealthy connection after timeout."), a.close()))
    }, Math.floor(b)))
  }
          ...
          if ("c" == d) {
            if (d = ud("t", c), "d" in c)
              if (c = c.d, "h" === d) {
                ...
                a.bd = a.F;
                for (c = 0; c < a.Nd.length; ++c) a.Jd(a.Nd[c]);
                a.Nd = [];
                Lh(a)
              } else "s" === d ? (a.f("Connection shutdown command received. Shutting down..."),
                a.Oe && (a.Oe(c), a.Oe = null), a.na = null, a.close()) : "r" === d ? (a.f("Reset packet received.  New host: " + c), cd(a.G, c), 1 === a.N ? a.close() : (Mh(a), Gh(a))) : "e" === d ? od("Server Error: " + c) : "o" === d ? (a.f("got pong on primary."), Nh(a), Oh(a)) : od("Unknown control packet command: " + d)
          } else "d" == d && a.Jd(c)
        } else if (b === a.F)
          if (d = ud("t", c), c = ud("d", c), "c" == d) "t" in c && (c = c.t, "a" === c ? Ph(a) : "r" === c ? (a.f("Got a reset on secondary, closing it"), a.F.close(), a.gd !== a.F && a.bd !== a.F || a.close()) : "o" === c && (a.f("got pong on secondary."),
            a.Rf--, Ph(a)));
          else if ("d" == d) a.Nd.push(c);
  ...
  function Rh(a, b, c, d) {
    ...
    Th(this, 0);
    hf.wb().Gb("visible", this.Ng, this); - 1 === a.host.indexOf("fblocal") && gf.wb().Gb("online", this.Lg, this)
  }
  var Sh = 0,
    Uh = 0;
  h = Rh.prototype;
  ...
  h.Ve = function (a) {
    this.qa && (a = {
      c: a
    }, this.f("reportStats", a), this.Ha("s", a, function (a) {
  ...
  h.Hf = function () {
    ...
    0 === this.Zc && (this.sa = []);
    this.Ud = {};
    di(this) && (this.Qb ? this.Mc && (3E4 < (new Date).getTime() - this.Mc && (this.bb = 1E3), this.Mc = null) : (this.f("Window isn't visible.  Delaying reconnect."), this.bb = this.Fd, this.Ge = (new Date).getTime()), a = Math.max(0, this.bb - ((new Date).getTime() - this.Ge)), a *= Math.random(), this.f("Trying to reconnect in " +
      a + "ms"), Th(this, a), this.bb = Math.min(this.Fd, 1.3 * this.bb));
    this.Vc(!1)
  };
  ...
  function bi(a) {
    ...
    for (; a.Wc.length;) b = a.Wc.shift(), Yh(a, b.action, b.oc, b.data, b.I)
  }
  ...
  h.fb = function (a, b, c) {
    var d = a.source.Jb;
    if (null !== d) return d = z(this.za, d), N(null != d, "SyncTree gave us an op for an invalid query."), d.fb(a, b, c);
    var e = [];
  ...
  function Bi(a, b, c) {
    ...
    d = a.va.subtree(d);
    if (e) N(null == li(d.value), "If we're adding a query, it shouldn't be shadowed");
    else
      for (e = tf(d, function (a, b, c) {
        if (!a.e() && b && null != li(b)) return [Xe(li(b))];
        var d = [];
        ...
        return d
      }), d = 0; d < e.length; ++d) c = e[d], a.Oc.ae(Ei(c), Fi(a, c));
    return b
  }
  ...
  h.update = function (a, b, c) {
    ...
    if (d) dc("update() called with empty data.  Don't do anything."), Pi(c, "ok");
    else {
      var g = this.Id++,
        k = ri(this.M, a, f, g);
      Yb(this.fa, k);
  ...
  function Si(a, b, c, d, e) {
    ...
    if (p(d)) {
      ...
      k.push(c);
      Wf(e, k);
      "object" === typeof d && null !== d && y(d, ".priority") ? (k = z(d, ".priority"), N(dg(k), "Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.")) :
        k = (a.M.Aa(b) || G).C().J();
      e = Mi(a);
      d = P(d, k);
      e = Vc(d, e);
      ...
      bc(a.fa, b, c);
      Ti(a)
    } else c.he(), c.pd = null, c.qd = null, c.I && (a = new W(c.od, new X(a, c.path), Q), c.I(null, !1, a))
  }
  ...
  function Wi(a, b, c) {
    for (var d = Pa(c, function (a) {
      return a.Da
    }), e = a.M.Aa(b, d) || G, d = e, e = e.hash(), f = 0; f < c.length; f++) {
      var g = c[f];
    ...
    a.da.put(b.toString(), d, function (d) {
      ...
      if ("ok" === d) {
        ...
        Ti(a);
        bc(a.fa, b, e);
        for (f = 0; f < d.length; f++) ec(d[f])
      } else {
        if ("datastale" === d)
          for (f = 0; f < c.length; f++) c[f].status = 4 === c[f].status ? 5 : 1;
        else
          for (R("transaction at " + b.toString() + " failed: " + d), f = 0; f < c.length; f++) c[f].status = 5, c[f].je = d;
        Ni(a, b)
      }
    }, e)
  }
  ...
  function Yi(a, b, c) {
    if (0 !== b.length) {
      for (var d = [], e = [], f = Oa(b, function (a) {
        ...
        if (5 === k.status) l = !0, r = k.je, e = e.concat(si(a.M, k.Da, !0));
        else if (1 === k.status)
          if (25 <= k.Qf) l = !0, r = "maxretry", e = e.concat(si(a.M, k.Da, !0));
          else {
            var x = a.M.Aa(k.path, f) || G;
            k.od = x;
            var J = b[g].update(x.J());
            p(J) ? (fg("transaction failed: Data returned ",
              J, k.path), m = P(J), "object" === typeof J && null != J && y(J, ".priority") || (m = m.ia(x.C())), x = k.Da, J = Mi(a), J = Vc(m, J), k.pd = m, k.qd = J, k.Da = a.Id++, Ua(f, x), e = e.concat(pi(a.M, k.path, J, k.Da, k.df)), e = e.concat(si(a.M, x, !0))) : (l = !0, r = "nodata", e = e.concat(si(a.M, k.Da, !0)))
          } bc(a.fa, c, e);
        e = [];
      ...
      Ui(a, a.xc);
      for (g = 0; g < d.length; g++) ec(d[g]);
      Ti(a)
    }
  }

  function Xi(a, b) {
    for (var c, d = a.xc; null !== (c = I(b)) && null === d.Ea();) d = Vf(d, c), b = M(b);
    return d
  }
  ...
  function $i(a, b) {
    var c = b.Ea();
    if (null !== c) {
      for (var d = [], e = [], f = -1, g = 0; g < c.length; g++) 4 !== c[g].status && (2 === c[g].status ? (N(f === g - 1, "All SENT items should be at beginning of queue."), f = g, c[g].status = 4, c[g].je = "set") : (N(1 === c[g].status, "Unexpected transaction status in abort"), c[g].he(), e = e.concat(si(a.M, c[g].Da, !0)), c[g].I && d.push(u(c[g].I, null, Error("set"), !1, null)))); - 1 === f ? Wf(b, null) : c.length = f + 1;
      bc(a.fa, b.path(), e);
      for (g = 0; g < d.length; g++) ec(d[g])
    }
  };
  ...
  aj.prototype.Ab = function () {
    for (var a in this.rc) this.rc[a].Ab()
  };
  aj.prototype.uc = function () {
    for (var a in this.rc) this.rc[a].uc()
  };
  ...
  function bj(a) {
    ...
    if (a.g === pe) {
      if (a.oa) {
        if ("[MIN_NAME]" != Ld(a)) throw Error("Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().");
      ...
      if (null != b && !dg(b) || null != c && !dg(c)) throw Error("Query: When ordering by priority, the first argument passed to startAt(), endAt(), or equalTo() must be a valid priority value (null, a number, or a string).");
    } else if (N(a.g instanceof te || a.g === ze, "unknown index type."), null != b && "object" === typeof b || null != c && "object" === typeof c) throw Error("Query: First argument passed to startAt(), endAt(), or equalTo() cannot be an object.");
  }

  function cj(a) {
    if (a.oa && a.ra && a.la && (!a.la || "" === a.Pb)) throw Error("Query: Can't combine startAt(), endAt(), and limit(). Use limitToFirst() or limitToLast() instead.");
  }
  ...
  h.Gb = function (a, b, c, d) {
    ...
    if ("value" === a) Ri(this.k, this, new ii(b, e.cancel || null, e.Pa || null));
    else {
      var f = {};
      f[a] = b;
  ...
  function ej(a, b, c) {
    ...
    if (b && c) d.cancel = b, E(a, 3, d.cancel, !0), d.Pa = c, Ob(a, 4, d.Pa);
    else if (b)
      if ("object" === typeof b && null !== b) d.Pa = b;
      else if ("function" === typeof b) d.cancel = b;
      else throw Error(D(a, 3, !0) + " must either be a cancel callback or a context object.");
    return d
  }
  ...
  function X(a, b) {
    ...
    if (a instanceof Ji) c = a, d = b;
      ...
      if (f) throw Error(D("new Firebase", 1, !1) + 'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".');
      if (b)
        if (b instanceof aj) e = b;
        else if (q(b)) e = aj.wb(), c.Pd = b;
  ...
  X.prototype.transaction = function (a, b, c) {
    ...
    if (p(c) && "boolean" != typeof c) throw Error(D("Firebase.transaction", 3, !0) + "must be a boolean.");
  ...
  X.prototype.jg = function (a, b, c, d) {
    ...
    var e = new A;
    q(b) ? (og("Firebase.authWithOAuthToken", 2, b), bh(this.k.O, a + "/token", {
      access_token: b
    }, d, B(e, c))) : (qg("Firebase.authWithOAuthToken", 2, b, !1), bh(this.k.O, a + "/token", b, d, B(e, c)));
    return e.D
  };
